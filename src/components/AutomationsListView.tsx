    ...
    <div className="flex-1 bg-slate-50 overflow-y-auto custom-scrollbar p-6 lg:p-8 space-y-6 select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-xs shadow-blue-600/20 transition-all active:scale-95 cursor-pointer shrink-0"
        >
